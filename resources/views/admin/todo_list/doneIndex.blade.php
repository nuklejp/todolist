...
@section('title', '完了済みtodo_listの一覧')
...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="{{ action('Admin\TodoListController@index') }}" role="button" class="btn btn-primary">未完了リスト</a>
            </div>
            <div class="col-md-8">
                            ...
                            @foreach($posts as $todo_list)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            <a href ="{{action('Admin\TodoListController@incomplete', ['id' => $todo_list->id])}}">未完了に戻す</a>
                                        </div>
                                    </td>
                                    @endif
                                </tr>
